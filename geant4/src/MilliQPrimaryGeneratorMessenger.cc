...

{
  ...
  fSetMomentumXVertexCmd = new G4UIcmdWithADoubleAndUnit("/gun/momentumxvertex",this);
...
MilliQPrimaryGeneratorMessenger::~MilliQPrimaryGeneratorMessenger()
{
  ...
  delete fSetMomentumXVertexCmd;
  delete fSetMomentumYVertexCmd;
  delete fSetMomentumZVertexCmd;
