...
// ********************************************************************
//
/// \file exoticphysics/monopole/src/MilliQMonopoleTransportation.cc
/// \brief Implementation of the MilliQMonopoleTransportation class
//
// $Id: MilliQMonopoleTransportation.cc 84606 2014-10-17 07:50:04Z gcosmo $
//
...
MilliQMonopoleTransportation::MilliQMonopoleTransportation( const MilliQMonopole* mpl,
							    G4int verb)
    ...
    fpSafetyHelper(0)
{
  ...
  fMagSetup = MilliQMonopoleFieldSetup::GetMonopoleFieldSetup();
...
G4double MilliQMonopoleTransportation::
...
{  
  ...
  *selection = CandidateForSelection ;
  ...
  if( currentSafety < endpointDistance ) 
	...
	G4cout.precision(12) ;
	G4cout << "***MilliQMonopoleTransportation::AlongStepGPIL ** " << G4endl  ;
...
G4VParticleChange* MilliQMonopoleTransportation::AlongStepDoIt( const G4Track& track,
  ...
  if ( fParticleIsLooping )
    {
      ...
      if( (endEnergy < fThreshold_Important_Energy) 
        ...
        if( (verboseLevel > 1) || 
          ...
          G4cout << " MilliQMonopoleTransportation is killing track that is looping or stuck "
                 << G4endl
...
G4VParticleChange* MilliQMonopoleTransportation::PostStepDoIt( const G4Track& track,
							       const G4Step& )
{
...
// of MilliQMonopoleTransportation object at the start of a new track
// or the resumption of a suspended track. 

void 
MilliQMonopoleTransportation::StartTracking(G4Track* aTrack)
{
