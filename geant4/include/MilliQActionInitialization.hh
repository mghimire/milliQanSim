...
public:
  MilliQActionInitialization(MilliQRecorderBase* recorder, const G4int geometryVersion, const boost::property_tree::ptree pt)
    : G4VUserActionInitialization(), fRecorder(recorder), fAlternate(geometryVersion), fPTree(pt) {}
