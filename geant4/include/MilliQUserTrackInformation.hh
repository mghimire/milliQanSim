...
// ********************************************************************
//
// $Id: MilliQUserTrackInformation.hh 68752 2013-04-05 10:23:47Z gcosmo $
//
/// \file optical/MilliQ/include/MilliQUserTrackInformation.hh
/// \brief Definition of the MilliQUserTrackInformation class
//
#include "G4VUserTrackInformation.hh"
#include "globals.hh"

#ifndef MilliQUserTrackInformation_h
#define MilliQUserTrackInformation_h 1

enum MilliQTrackStatus { active=1, hitPMT=2, absorbed=4, boundaryAbsorbed=8, inactive=14};
...
class MilliQUserTrackInformation : public G4VUserTrackInformation
{
public:

  MilliQUserTrackInformation();
  virtual ~MilliQUserTrackInformation();
