...
w// * conditions of the Geant4 Software License,  included in the file *
...
// ********************************************************************
//
/// \file exoticphysics/monopole/include/MilliQMonopoleTransportation.hh
/// \brief Definition of the MilliQMonopoleTransportation class
//
// $Id: MilliQMonopoleTransportation.hh 69705 2013-05-13 09:09:52Z gcosmo $
//
...
// Class description:
//
// MilliQMonopoleTransportation is a process responsible for the transportation of
...
#ifndef MilliQMonopoleTransportation_hh
#define MilliQMonopoleTransportation_hh 1
...
class MilliQMonopoleTransportation : public G4VProcess
{
  // Concrete class that does the geometrical transport 

public:  // with description

  MilliQMonopoleTransportation(const MilliQMonopole* p, G4int verbosityLevel= 1);
  ~MilliQMonopoleTransportation();
...
private:
  ...
  const MilliQMonopole* fParticleDef;

  MilliQMonopoleFieldSetup*  fMagSetup;
...
#include "MilliQMonopoleTransportation.icc"
