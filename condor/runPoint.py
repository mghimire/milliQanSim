...
sourceFilesDir = "/data/users/bfrancis/condor/milliqan/SourceFiles/"

massDict = {
    'mCP_UFO' : [0.1, 0.28, 0.43, 0.6, 0.78, 
    ...
    'JPsi' : [0.1, 0.28, 0.43, 0.6, 0.78, 1.0, 1.25],
    'Y1S'  : [0.1, 0.28, 0.43, 0.6, 0.78, 1.0, 1.25, 1.52, 1.84, 2.2, 2.6, 3.04, 3.54, 4.1],
    'Y2S'  : [0.1, 0.28, 0.43, 0.6, 0.78, 1.0, 1.25, 1.52, 1.84, 2.2, 2.6, 3.04, 3.54, 4.1],
    'Y3S'  : [0.1, 0.28, 0.43, 0.6, 0.78, 1.0, 1.25, 1.52, 1.84, 2.2, 2.6, 3.04, 3.54, 4.1],
    'Sample' : [0.28, 8.9, 92.6],
    'cosmicmuons' : [0.105],
    'am241' : [0.000],
}
...
if proc != 'cosmicmuons' and proc != 'am241':
    ...
    subprocess.call('sed -i "s~PathName.*~PathName = ' + sourceFilesDir + '~g" config/particles.ini', shell = True)
